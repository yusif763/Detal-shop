...
const updateProduct = `/product-api/product-detail/${slug}`
...
searchBtn.addEventListener('click',e => {
    ...
    .then((response) => response.json())
.then((responseJson) => {
    // '/product/single-product/amil-20211204-154055/'

    document.location.href = `/product/single-product/${responseJson['slug']}/`;
